...
class MissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mission" do
    assert_difference("Mission.count") do
      post missions_url, params: { mission: { legal_entity_id: @mission.legal_entity_id, name: @mission.name, sso_uuid: @mission.sso_uuid } }
    end
  ...
  test "should update mission" do
    patch mission_url(@mission), params: { mission: { legal_entity_id: @mission.legal_entity_id, name: @mission.name, sso_uuid: @mission.sso_uuid } }

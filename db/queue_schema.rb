...
ActiveRecord::Schema[8.1].define(version: 2026_06_28_133034) do
  ...
  create_table "entity_users", force: :cascade do |t|
    ...
    t.index ["legal_entity_id"], name: "index_entity_users_on_legal_entity_id"
